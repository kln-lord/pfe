                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#"
                                id="navbarDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="./assets/images/pfp.jpeg" alt="user" class="" /> <span
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="favorites-page.php" aria-expanded="false"><i
                                    class="fa fa-heart"></i><span class="hide-menu">Favorites</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="checkout-page.php" aria-expanded="false"><i
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="balance">
                                    ...
                                    <br>
                                    <div class = "amount">$ 10,000<br><div style="color:gray ; font-size:0.9rem;">Balance</div></div>
                                </div>
                                <div class="incoming-flights">
                                    <br>
                                    <div class="your-flights"><i style="scale: 1.8;" class="fa fa-plane" aria-hidden="true"></i></div>
                                    <br>
                                    <div class = "number-flights">2<br><div style="color:gray ; font-size:0.9rem;">Flights</div></div>
                                </div>
                                <!-- <div class="balance">
                                    <br>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bookings">
                                    ...
                                    <br>
                                    <div class = "number-bookings">4<br><div style="color:gray ; font-size:0.9rem;">Favorites</div></div>
                                </div>
                            </div>
                        </div>
                    </div>
